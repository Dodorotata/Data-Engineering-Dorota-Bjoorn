...
from include.queue_time.extract import extract_queue_time   # import task_group extract_queue_time
...
def queue_time_ELT():
    ...
    # can be scheduled for example 1/h so since different that queue_tiem_ELT use "timetable" functionality in Airflow
